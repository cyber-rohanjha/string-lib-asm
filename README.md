...
A continuation of the [x86-64 Assembly Math Library](https://github.com/black_swan/math-lib-asm), this project implements standard string operations at the hardware level — no libc, no compiler abstractions, just raw SSE instructions and registers.
